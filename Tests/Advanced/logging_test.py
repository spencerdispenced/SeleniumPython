...
import logging
# import POM models
from Pages.swag_models import SwagPage
...
class Logging_test(unittest.TestCase):
    ...
    def setUpLogger(self):
        ...
        logging.basicConfig(filename='C:\\Users\\spenc\\OneDrive\\Desktop\\study_stuff\\Practice\\Selenium\\SeleniumPython\\Logs\\SwagLogs.log',
    ...
    def setUp(self):
        ...
        self.logger.info("Opening SwagLabs")
    ...
    def test_multiple_logins(self):
        try:
            ...
            self.logger.warn("Getting data from excel")
            ...
            print("FAIL: " + e)
            self.logger.error("Failed getting info from excel")
        ...
        for i in range(1, row_count):
            ...
            self.logger.warn("Entering login data")
            swag_page = SwagPage(self.d)
            swag_page.login_user(username, password)
